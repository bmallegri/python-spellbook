...
Anything you inscribe also turns up in Flash Cards: the name on the front, what it does and when to reach for it on the back. That one is early on purpose. A card turns over and takes a rating, easy, shaky or lost, and the page says what is still missing.
